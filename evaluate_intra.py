...
# Set the model number here manually
model_number = 40  # <-- Change this to load different models
...
ticker = "TATASTEEL.NS" 
#ticker = "RELINFRA.NS"
data_df = yf.download(tickers=ticker, period="1d", interval="5m")
...
# Summary
print("--------------------------------")
print(f"{ticker} Total Trading Profit: {formatPrice(total_profit)}")
